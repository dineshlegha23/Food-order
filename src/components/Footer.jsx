  ...
  return (
    <div className="bg-black/80" id="contact">
      <div className="max-w-[1200px] mx-auto p-5 text-white  mt-10 pt-16">
        <div className="grid grid-cols-4 md:grid-cols-3 xs:grid-cols-1 pb-10 border-b-[1px] border-gray-400">
          <div className="max-w-[400px] col-span-2 xs:col-span-1">
            <div className="mb-5">
          ...
          <div className="justify-self-end md:justify-self-start xs:mt-10 md:mt-10">
